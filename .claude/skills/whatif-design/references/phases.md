...
✅ `python -c "import whatif.types"` under 50ms.
...
- Imported from user code via `from whatif.contract import ...`
...
- `whatif` package
- `whatif-langfuse` package
- `whatif-inspect-ai` package
...
- `python -c "import whatif"` time budget
