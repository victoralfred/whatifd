...
- **Still deferred:** an HTTP-level recorded cassette for `DatadogExportClient` (needs a content-scrubbed real response body), and P1b Datadog verdict sink (CI-side emitter), per the integrations plan.
