...
Mirrors `packages/whatif-langfuse/tests/conftest.py`. The harness
...
If the harness is ever promoted to `whatif.testing.adapter_conformance`
...
_HARNESS_MISSING_MESSAGE = (
    "whatif-inspect-ai conftest cannot locate the conformance harness at "
...
if (_HARNESS_DIR / "conformance.py").is_file():
    ...
    print(
        f"[whatif-inspect-ai conftest] WARNING: {_HARNESS_MISSING_MESSAGE}",
        file=sys.stderr,
    )
