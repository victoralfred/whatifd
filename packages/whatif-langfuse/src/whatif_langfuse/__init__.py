"""`whatif-langfuse` — Langfuse `TraceSource` adapter for whatif.

Phase 4B.1 of the v0.1 plan. Implements `whatif.adapters.TraceSource`
...
from whatif_langfuse.source import LangfuseTraceSource
