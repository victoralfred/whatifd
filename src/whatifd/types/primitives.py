...
Everything else in `whatif/types/` builds on these.
...
The format/parse helpers live in `whatif/serialization/decimal.py`
...
# `whatif/serialization/decimal.py` (Phase 5) for format/parse helpers.
