"""Tests for `whatifd.decision.floor` — Phase 1.4 witness + Phase 2.1 evaluator.
...
from whatifd.decision.floor import (
    FloorFailureSet,
    FloorPassedProof,
    compute_cohort_floor_failures,
    evaluate_floor,
)
from whatifd.types import CohortResult, FloorFailure, TrustFloor
