"""Tests for `whatifd.replay.result` — Phase 6.1 typed replay-stage
result.
...
from whatifd.replay import ReplayFailure, ReplayResult, ReplaySuccess
...
class TestReplaySuccess:
    ...
    def test_no_dict_no_arbitrary_attribute(self) -> None:
        ...
        # tests/unit/whatifd/types/test_failure.py — accept any of the
